...
class chaser:
    def __init__(self):
        ...
        # ------------ Subscriptions -------------
        self.sub = rospy.Subscriber('/robot_1/odom', Odometry, self.saveOdomSelf)               # chaser Team A
        self.sub = rospy.Subscriber('/robot_12/odom', Odometry, self.saveOdomGoal)              # goal Team B
        self.sub = rospy.Subscriber('/robot_13/odom', Odometry, self.saveOdomQuaffle)            # quaffle
